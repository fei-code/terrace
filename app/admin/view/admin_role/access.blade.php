...
@section('content')
    ...
    <link rel="stylesheet" type="text/css" href="/static/admin/css/access.css">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body" id="all_check">
                    <form id="dataForm" class="form-horizontal dataForm" action="/admin/admin_role/access" method="post"
