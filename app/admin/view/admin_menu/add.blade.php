    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form id="dataForm" class="dataForm form-horizontal"
                      @if(isset($data)) action="/admin/admin_menu/{{$data->id}}"
                      @else
                                ...
                                <div class="col-sm-10 col-md-4">
                                    <div class="input-group iconpicker-container">
                                        ...
                                        <input maxlength="30" id="icon" name="icon"
                                               value="{{$data->icon ?? 'fa-list'}}" class="form-control "
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    <input class="input-switch" id="is_show" value="1"
                                           @if (isset($data) && $data->is_show ==1) checked @endif
                                         type="checkbox"/>
                                    <input class="switch" name="is_show" value="{{$data->is_show ?? 1}}"
                                           placeholder="" hidden/>
                                </div>
                            </div>
                            <script>
