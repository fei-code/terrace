        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-header">
                    <div>
                        <a title="添加" data-toggle="tooltip" class="btn btn-primary btn-sm " href="/admin/setting/create">
                      ...
                      @foreach($data as $item)
                        <tr>
                            ...
                            <td class="td-do">
                                ...
                                <a href="/admin/setting/{{$item->id}}/edit"
                                ...
                                <a class="btn btn-danger btn-xs AjaxButtonDelete" data-toggle="tooltip" title="删除"
                                   ...
                                   data-url="/admin/setting/{{$item->id}}">
